...
typeset with strict adherence to \ac{iso-math}\index{ISO/IEC 80000-2:2009}.
...
its symbol should be bold and upright: \eye{n}\SideNote{This marks a deviation
from the \acs*{iso}/\acs*{iec} standard which discloses a bold italicised
$\mathbfit{I}$ for this purpose. I view this as an oversight in the standard
since it departs from the convention of printing mathematical constants in
Roman. I have found good examples where others make this same
deviation.}[-1.5cm].
