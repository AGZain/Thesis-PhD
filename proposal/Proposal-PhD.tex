...
% \setmathfont[range={}, Path=/home/timtro/.fonts/type1/Libertinus/]{libertinusmath-regular.otf} % Reload with empty range for correct spacing

%% Code between BEGIN and END tTechnicalNoteCopy was taken from my
%% tTechnicalNote class.
...
\AddEverypageHook{
  \begin{tikzpicture}[remember picture,overlay]
    % \node [rotate=asin(8.5/11),scale=8] at (current
    % page.center) {\sffamily\color{gray!14}\huge DRAFT};
    \node [yshift=1cm] at (current page.south) {\sffamily\color{black!30}\large Draft of \today};
  \end{tikzpicture}
}
...
\frontmatter
  ...
  %   \tableofcontents
  % }
\mainmatter\pagestyle{fullwidth}
...
\backmatter%
  {
    ...
    % \begingroup
    % \renewcommand{\addcontentsline}[3]{}% Remove bib from ToC
    \printbibliography%
    % \endgroup
  }
  \printindex
