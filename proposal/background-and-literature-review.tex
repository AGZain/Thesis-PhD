...
In \Sref{sec:literature-gaps} I specifically outline the gaps in literature
...
available to the user. It wasn't until \anno{1998} that the language was
...
\anno{\citeyear{Al-Khanji2015}}, \citeauthor{Al-Khanji2015} produced a thesis
...
2014\SideNote{\url{youtu.be/tyaYLGQSr4g?t=38m32s}}[\onelineskip].

In \citeyear{Peterson2001}, \citeauthor{Peterson2001} produced a case study
...
using constraint techniques in the mathematical optimisation\SideNote{For
example, using Lagrange multipliers, or \ac{nlp}}. Techniques which penalise
...
constraints.}\index{Constraints!soft} This brings us to our final and most
